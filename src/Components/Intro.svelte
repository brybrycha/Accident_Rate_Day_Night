<section>
  <p class="body-text">
    <span class="highlight">P</span>icture a busy highway on a random day in Camden, UK. 
    ...
    <br><br>
    Quite an odd question, but get this; <span class='color'>what if the time of day could predict the likelihood of such accidents?</span>
    <br><br>
